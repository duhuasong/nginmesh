...
istioctl create -f ../nginmesh-0.2.12/samples/kubernetes/route-rule-reviews-50-v3.yaml
sleep 5;
i=0 
j=0
k=0
...
istioctl delete -f ../nginmesh-0.2.12/samples/kubernetes/route-rule-reviews-50-v3.yaml
